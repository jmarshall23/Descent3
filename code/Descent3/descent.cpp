...
| Descent3()                                                                             |
| 1. Set Game Version:                                                                   |
|    - Development or Release based on debug settings                                    |
|    - Adjusts based on Beta or Demo versions if applicable                              |
| 2. Parse Command Line:                                                                 |
|    - Check for proxy settings and configure if found                                   |
| 3. Intro and Loading Screens:                                                          |
|    - Skip if in dedicated server mode                                                  |
|    - Play Dolby and other intro movies if not skipped via "-nointro"                   |
|    - Display static intro screen                                                       |
| 4. Initialize Game Systems:                                                            |
|    - Call InitD3Systems1() and InitD3Systems2() for setup                              |
| 5. Main Game Loop:                                                                     |
|    - Controlled by MainLoop() function                                                 |
|      +----------------------------------------------------------------------------+    |
|      | MainLoop()                                                                 |    |
|      | - Repeat until exit_game flag is set                                       |    |
|      | - Handle game modes: QUIT_MODE, MENU_MODE, GAME_MODE, CREDITS_MODE, etc.   |    |
|      | - Actions per mode:                                                        |    |
|      |    * QUIT_MODE: Set exit_game to 1                                         |    |
|      |    * MENU_MODE: Show main menu and process choices                         |    |
|      |    * GAME_MODE: Load and start gameplay                                    |    |
|      |    * CREDITS_MODE: Display game credits, then return to menu               |    |
|      | - Special handling for GameGauge and Editor modes if defined               |    |
|      +----------------------------------------------------------------------------+    |
| 6. Error Handling:                                                                     |
|    - Catch exceptions related to file operations                                       |
|    - Show error message and exit                                                       |
| 7. Cleanup and Exit:                                                                   |
|    - Delete lock files                                                                 |
|    - Save game settings to registry                                                    |
|    - Free resources and reset screen mode                                              |
+----------------------------------------------------------------------------------------+
*/
