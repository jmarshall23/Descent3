...
// IceColdDuke - Disabled Entire File, missing source code. 
object_info Robots[MAX_ROBOTS];
...
void CWorldObjectsRobotDialog::UpdateRobotView(void)
{
	...
	static int last_robot=-1;
	static int last_render_handle=-1;
	static int robot_dir=0;
	...
	g3_StartFrame (&view_vector,&id_matrix,D3_DEFAULT_ZOOM);
      DrawPolygonModel(&zero_vector, &rot_matrix, bm_handle, norm_angles, 0, NULL, 1.0);
	g3_EndFrame();
